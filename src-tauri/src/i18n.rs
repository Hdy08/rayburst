...
pub fn open_file_action(locale: &str) -> String {
    rust_i18n::t!("notification.open-file-action", locale = locale).into_owned()
}

pub fn show_in_folder_action(locale: &str) -> String {
    rust_i18n::t!("notification.show-in-folder-action", locale = locale).into_owned()
}
